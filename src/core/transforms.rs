...
//     sum: T,
//     sequence: Box<dyn Iterator<Item = T>>,
//     val: T,
//     x: T,
// }

// impl<T: One + Zero> PowerSeries<T> {
//     pub fn new<I>(sequence: I, x: T) -> Self
//     where
//         I: Iterator<Item = T> + 'static,
//     {
//         Self {
...
// impl<T: CheckedSub + One + Zero> PowerSeries<T> {
//     pub fn new_with_center<I>(sequence: I, x: T, c: T) -> Self
//     where
//         I: Iterator<Item = T> + 'static,
//     {
//         Self {
...
//             sequence: Box::new(sequence),
//             val: T::one(),
//             x: x.checked_sub(&c).unwrap(),
//         }
//     }
// }

// impl<T: Clone + CheckedAdd + CheckedMul> Iterator for PowerSeries<T> {
//     type Item = T;
...
//         self.sum = self
//             .sum
//             .checked_add(&self.val.clone().checked_mul(&self.sequence.next()?)?)?;
