...
use crate::utils::divisibility::{abundancy_index, aliquot_sum, proper_divisors};
...
crate::check_sequences!(
    ...
    Superabundant::new(),     [1, 2, 4, 6, 12, 24, 36, 48, 60, 120, 180, 240, 360, 720, 840, 1260, 1680, 2520, 5040, 10080, 15120, 25200, 27720, 55440, 110880, 166320, 277200, 332640, 554400];
);
