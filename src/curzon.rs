...
use num::{BigInt, CheckedAdd, CheckedMul, FromPrimitive, Integer, Zero};
...
/// ```text
/// k = 2
/// 1, 2, 5, 6, 9, 14, 18, 21, 26, 29, 30, 33, 41, 50, 53, 54, 65, 69...
/// ```
pub struct Curzon<T> {
    base: T,
    ctr: T,
...
impl<T: Clone + CheckedAdd + CheckedMul + Integer> Iterator for Curzon<T> {
    type Item = T;
